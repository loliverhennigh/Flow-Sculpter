...
\begin{figure}[h]
\begin{center}
\subfigure{\includegraphics[scale=0.27]{../test/figs/heat_learn_gradient_decent.pdf}}
\subfigure{\includegraphics[scale=0.27]{../test/figs/heat_learn_comparison.pdf}}
\end{center}
...
\begin{figure}[!t]
\begin{center}
\subfigure{\includegraphics[scale=0.25]{../test/figs/generated_flow_difference.pdf}}
\subfigure{\includegraphics[scale=0.095]{../test/figs/flow_accuracy_2d.pdf}}
\end{center}
...
\begin{figure}[h]
\begin{center}
\subfigure{\includegraphics[scale=0.27]{../test/figs/learn_gradient_descent_3d.pdf}}
\subfigure{\includegraphics[scale=0.27]{../test/figs/3d_wing_paraview.jpg}}
\end{center}
\caption{Flow}
\end{figure}
